 ...
 */
@Configuration
public class LigaConfiguration {
    ...
    @Bean
    public LigaClient concatenarClient(Jaxb2Marshaller marshaller) {
        LigaClient client = new LigaClient();
        client.setDefaultUri("http://localhost:8080/liga");
